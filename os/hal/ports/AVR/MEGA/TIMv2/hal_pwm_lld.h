...
/**
 * @brief   Waveform generation mode (WGM).
 */
typedef enum  {

  PWM_WGM00_NORMAL,             /**< WGM, Normal mode.       */
  PWM_WGM01_PHASE_CORRECT8,     /**< WGM, phse correct, 8 bit.  */
  PWM_WGM02_PHASE_CORRECT9,     /**< WGM, phse correct, 9 bit.  */
  PWM_WGM03_PHASE_CORRECT10,    /**< WGM, phse correct, 10 bit. */
  PWM_WGM04_CTC,                /**< WGM, CTC mode. */
  PWM_WGM05_FAST,               /**< WGM, fast pwm mode. */
  PWM_WGM06_FAST,               /**< WGM, fast pwm mode. */
  PWM_WGM07_FAST,               /**< WGM, fast pwm mode. */
  PWM_WGM08_PHASE_FREQ_CORRECT, /**< WGM, phase frequence correct.*/
  PWM_WGM09_PHASE_FREQ_CORRECT, /**< WGM, phase frequence correct.*/
  PWM_WGM10_PHASE_CORRECT,      /**< WGM, phase correct mode.*/
  PWM_WGM11_PHASE_CORRECT,      /**< WGM, phase correct mode.*/
  PWM_WGM12_CTC,                /**< WGM, CTC mode, top = ICRn. */
  PWM_WGM13_RESERVED,           /**< WGM, RESERVED mode.                */
  PWM_WGM14_FAST_PWM,           /**< WGM, fast pwm mode, top = ICRn.    */
  PWM_WGM15_FAST_PWM,           /**< WGM, fast pwm mode, top = ORCnA.   */
}
/*===========================================================================*/
